 ...
 */
public class ManagePopulate implements TestSuite {

    private final String collectorId;
    private final String sensorId;
    private final int total;

    public ManagePopulate(String collectorId, String sensorId, int total) {
    ...
    public void start() {
        ...
        try {
            ...
            for (int j = 1; j <= total; j++) {
                Thread.sleep(1);
                collectorDataBuilder.publishSample(sensorId, j);
            }
