package br.uff.labtempo.osiris.function.min.configuration;
...
public class AppConfig {
    ...
    public static final String FUNCTION_DESCRIPTION = "minimum of all values";
    public static final String MODULE_NAME = "min.function";
