 ...
 */
package br.uff.labtempo.osiris.function.max;

import br.uff.labtempo.omcp.client.rabbitmq.RabbitClient;
import br.uff.labtempo.omcp.server.OmcpServer;
import br.uff.labtempo.omcp.server.rabbitmq.RabbitServer;
import br.uff.labtempo.osiris.function.max.configuration.AppConfig;
import br.uff.labtempo.osiris.function.max.controller.MainController;
