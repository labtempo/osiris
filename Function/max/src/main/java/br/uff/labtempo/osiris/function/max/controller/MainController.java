 ...
 */
package br.uff.labtempo.osiris.function.max.controller;
...
public class MainController extends Controller {
    ...
    private double calculate(List<Double> values) throws BadRequestException {
        if(values == null || values.isEmpty()) throw new BadRequestException("Failed to calculate the maximum value: empty/null list of values");
