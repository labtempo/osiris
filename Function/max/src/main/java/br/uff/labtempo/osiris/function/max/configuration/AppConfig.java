package br.uff.labtempo.osiris.function.max.configuration;
...
public class AppConfig {
    ...
    public static final String FUNCTION_DESCRIPTION = "maximum of all values";
    public static final String MODULE_NAME = "max.function";
