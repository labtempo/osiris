package br.uff.labtempo.osiris.function.sum.configuration;
...
public class AppConfig {
    ...
    public static final String FUNCTION_DESCRIPTION = "sum of all values";
    public static final String MODULE_NAME = "sum.function";
