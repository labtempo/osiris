 ...
 */
package br.uff.labtempo.osiris.function.average;
...
import br.uff.labtempo.osiris.function.average.controller.MainController;

import java.util.Properties;

/**
 * Class that Bootstraps the OMCP Server for the Function Module
...
public class Bootstrap implements AutoCloseable {
    ...
    public Bootstrap(Properties properties) throws Exception {
        ...
        try {            
            ...
            close();
            throw new RuntimeException(String.format("Failed to bootstrap the omcpServer for the %s module", moduleName));
        }
    }
