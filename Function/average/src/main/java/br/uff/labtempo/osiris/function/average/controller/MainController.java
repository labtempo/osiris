 ...
 */
package br.uff.labtempo.osiris.function.average.controller;
...
import br.uff.labtempo.osiris.function.average.configuration.AppConfig;
...
public class MainController extends Controller {
    ...
    public Response process(Request request) throws MethodNotAllowedException, NotFoundException, InternalServerErrorException, NotImplementedException, BadRequestException {
        try {
            ...
            return new Response(AppConfig.PROTOCOL_VERSION, StatusCode.INTERNAL_SERVER_ERROR, Calendar.getInstance(), AppConfig.MODULE_NAME, null, 0, RESPONSE_ERROR_MEDIATYPE, null, "Failed to process request");
        }
    }
    ...
    private double calculate(List<Double> values) throws BadRequestException {
        if(values == null || values.isEmpty()) throw new BadRequestException("Failed to calculate the average: empty/null list of values");
