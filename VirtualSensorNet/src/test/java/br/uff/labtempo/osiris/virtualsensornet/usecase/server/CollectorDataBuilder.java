...
public class CollectorDataBuilder {
    ...
    public CollectorDataBuilder(String networkId, String collectorId, String sensorId) {
    ...
    public CollectorDataBuilder(String networkId, String collectorId) {
        this(networkId, collectorId, null);
    }
