 ...
 * @author Felipe
 */
public class OmcpServer implements ServerRequestListener {
    ...
    public OmcpServer(String moduleName, String host, String user, String password) {
    ...
    public void incoming(String message, ServerResponseContainer responseContainer) {
        ...
        try {
            ...
            response = this.router.routify(request);
